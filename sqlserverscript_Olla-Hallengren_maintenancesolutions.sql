...
DECLARE @BackupDirectory nvarchar(max)     = 'c:\sql_backups\'        -- Specify the backup root directory. If no directory is specified, the default backup directory is used.
...
@Verify nvarchar(max) = 'Y',
@CleanupTime int = NULL,
@CleanupMode nvarchar(max) = 'AFTER_BACKUP',
@Compress nvarchar(max) = 'Y',
